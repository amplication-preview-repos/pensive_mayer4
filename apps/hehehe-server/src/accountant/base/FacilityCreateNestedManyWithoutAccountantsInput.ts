...
@InputType()
class FacilityCreateNestedManyWithoutAccountantsInput {
...
export { FacilityCreateNestedManyWithoutAccountantsInput as FacilityCreateNestedManyWithoutAccountantsInput };
