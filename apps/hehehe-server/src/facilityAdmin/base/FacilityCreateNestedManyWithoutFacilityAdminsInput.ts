...
@InputType()
class FacilityCreateNestedManyWithoutFacilityAdminsInput {
...
export { FacilityCreateNestedManyWithoutFacilityAdminsInput as FacilityCreateNestedManyWithoutFacilityAdminsInput };
